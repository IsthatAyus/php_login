      ...
      <div class="container">
        <div class="row gy-4 justify-content-between">
          ...
          <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
            <h1>A php core project made by <span>Ayush Shrestha</span></h1>
            <p>Just doing a sample project to learn PHP core concepts.</p>
            <div class="d-flex">
